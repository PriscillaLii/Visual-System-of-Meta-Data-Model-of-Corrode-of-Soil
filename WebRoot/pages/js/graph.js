...
tern.classdef('Diagram',tern.UIContainer,{
  ...
  paint: function(context) {
    ...
    this.context.shadowColor = '#f2f2f2';
...
tern.classdef('RectangleShape',tern.Shape,{
  ...
  paint: function(context) {
    context.lineWidth = 1;    
    context.strokeStyle ="#68A521";
    context.fillStyle ="#fdfdfd";
    context.shadowBlur=15;
    context.shadowColor="#7f7f7f";
    context.fillRect(0, 0,this.width,this.height);
    ...
    if(this.connectors.length <= 0){
    	this.addConnector(new tern.ShapeConnector(0,this.height/3));
    	this.addConnector(new tern.ShapeConnector(0,(this.height/3)*2));
    	this.addConnector(new tern.ShapeConnector(this.width,this.height/3));
    	this.addConnector(new tern.ShapeConnector(this.width,(this.height/3)*2));
    }
